...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listBox1->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &MainFrame::listBox1_MouseDown);
			// 
			// timer
			// 
...
private: System::Void listBox1_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
	...
	if (e->Button == System::Windows::Forms::MouseButtons::Right)
	{
		...
		if (listBox1->Items->Count == 1 && (listBox1->Items[0]->ToString() == "Liste der vorhandenen Züge"))
			return;
		else if (listBox1->SelectedIndex >= 0 && (listBox1->Items[0]->ToString() != "Liste der vorhandenen Züge"))
		{
...
private: System::Void toolStripMenuItem1_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (en->ShowDialog(this) == ::DialogResult::OK) { //User pressed OK
		...
		if (en->Name == "") { 
			MessageBox::Show(L"Zugname darf nicht leer sein!");
		}
	
		else {
			SelectedTrain->Name = en->Name;
			updateTrainList(userdata, appdata, listBox1);
			textBox1->AppendText(L"Zugname erfolgreich zu " + SelectedTrain->Name + " geändert!\r\n");
