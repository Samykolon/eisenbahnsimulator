...
Appdata::Appdata()
{
	...
	trains->Add(L"train_steam", gcnew Train(TrainType::SteamEngine, "Dieselzug", L"Rails/Rail_Curve_LeftTop.png", 1));
	trains->Add(L"train_diesel", gcnew Train(TrainType::DieselEngine, "Dampflok", L"Rails/Rail_Curve_LeftTop.png", 10));
