...
Appdata::Appdata()
{
	...
	trains->Add(L"train_electric", gcnew Train(TrainType::ElectricLocomotive, "Elektrischer Zug", L"Rails/Rail_Curve_LeftTop.png", 5));
	trains->Add(L"train_steam", gcnew Train(TrainType::SteamEngine, "Dampflok", L"Rails/Rail_Curve_LeftTop.png", 1));
	trains->Add(L"train_diesel", gcnew Train(TrainType::DieselEngine, "Dieselzug", L"Rails/Rail_Curve_LeftTop.png", 10));
