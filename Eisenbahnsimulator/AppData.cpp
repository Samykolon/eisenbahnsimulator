...
Appdata::Appdata()
{
	...
	trains->Add(L"train_electric", gcnew Train(TrainType::ElectricLocomotive, "train_electric", L"Rails/Bush.png", 50));
	trains->Add(L"train_steam", gcnew Train(TrainType::SteamEngine, "train_steam", L"Rails/Bush.png", 10));
	trains->Add(L"train_diesel", gcnew Train(TrainType::DieselEngine, "train_diesel", L"Rails/Bush.png", 100));
